...
CRITICAL: add_annotation signature is (fig, x, y=None, text='', col=None) — y comes BEFORE text.
All calls to add_annotation must use text= as a keyword argument to avoid positional mismatch.
</context>
